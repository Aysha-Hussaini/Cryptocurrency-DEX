  ...
  render(){
    return (
      <form onSubmit={(event) => {
         ...
         tokenAmount= this.props.web3.utils.toWei(tokenAmount, 'Ether')
         ...
         <div className="mb-5 flex">
            <small className="text-grey float-right "><h5>&nbsp; &nbsp;Exchange Rate 150 Ext = 1 Eth  </h5></small>
         </div>
